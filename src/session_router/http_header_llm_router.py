...
http_header_fastapi_router_app = init()
...
class HttpHeaderLLMRouter:
    ...
    @http_header_fastapi_router_app.get("/v1/models", response_model=ModelList)
    ...
    @http_header_fastapi_router_app.get("/v1/models/{model:path}", response_model=ModelCard)
    ...
    @http_header_fastapi_router_app.post("/v1/completions")
